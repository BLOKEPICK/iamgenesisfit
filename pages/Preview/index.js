        ...
        <nav className="mobile-nav">
          <div>
            ...
            <div className="mobile-nav-footer">
              <div style={{ fontWeight: 700, fontSize: '5.5rem' }}><span style={{ fontWeight: 400 }}>Genesis</span> Fit</div>
              <div style={{ display: 'flex', gap: '1rem' }}>
                <a href="https://instagram.com/GeorgeValdezR" target="_blank"><FaInstagram size={44} /></a>
