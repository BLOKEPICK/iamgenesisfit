      ...
      <main>
        ...
        <section style={{ background: 'radial-gradient(circle at top left, #A79978, #fff)', color: '#', padding: '4rem 2rem' }}>
          <div className="trainer-section" style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', alignItems: 'center', maxWidth: '1000px', margin: '0 auto' }}>
            ...
            />
            <div style={{ flex: 1 }}>
             <center> <h2 style={{ color: '#673306', fontSize: '2rem', marginBottom: '1rem' }}>Conoce a Genesis</h2> </center>
              <p style={{ color: '#000000', fontSize: '1rem', lineHeight: 1.6 }}>
        ...
        {/* FAQ */}
        <section style={{ background: 'radial-gradient(circle at top left, #A79978, #A79978)', color: '#', padding: '4rem 2rem' }}>
